...
const nodbUtil = require('oracledb/lib/util');
...
const AqEnqOptions = require('oracledb/lib/aqEnqOptions');
const AqMessage = require('oracledb/lib/aqMessage');
const AqQueue = require('oracledb/lib/aqQueue');
const BaseDbObject = require('oracledb/lib/dbObject');
const Connection = require('oracledb/lib/connection');
const Lob = require('oracledb/lib/lob');
const Pool = require('oracledb/lib/pool');
const PoolStatistics = require('oracledb/lib/poolStatistics');
const ResultSet = require('oracledb/lib/resultset');
const SodaDatabase = require('oracledb/lib/sodaDatabase');
const SodaCollection = require('oracledb/lib/sodaCollection');
const SodaDocCursor = require('oracledb/lib/sodaDocCursor');
const SodaDocument = require('oracledb/lib/sodaDocument');
const SodaOperation = require('oracledb/lib/sodaOperation');
